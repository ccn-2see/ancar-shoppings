...
assert(overview.includes('data-ancar-ui-version="5.8.3"'),'V5.8.3: marcador da home ausente');
assert(rootRoute.includes('ancar-ui=5.8.3')&&rootRoute.includes('content: "5.8.3"'),'V5.8.3: versão/cache bust ausente');
...
assert(energy.includes('Custo energético')&&energy.includes('Custo acima da meta')&&energy.includes('Emissões associadas')&&energy.includes('Emissões evitadas')&&energy.includes('Intensidade de carbono'),'Energia & Carbono: KPIs econômicos/carbono ausentes');
...
console.log('VALIDAÇÃO DE FONTE V5.8.3: PASS');
