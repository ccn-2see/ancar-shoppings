...
assert(overview.includes('data-ancar-ui-version="5.8.7"'),'V5.8.7: marcador da home ausente');
assert(rootRoute.includes('ancar-ui=5.8.7')&&rootRoute.includes('content: "5.8.7"'),'V5.8.7: versão/cache bust ausente');
...
console.log('VALIDAÇÃO DE FONTE V5.8.7: PASS');
