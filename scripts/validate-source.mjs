...
assert(overview.includes('data-ancar-ui-version="5.8.2"'),'V5.8.2: marcador da home ausente');
assert(rootRoute.includes('ancar-ui=5.8.2')&&rootRoute.includes('content: "5.8.2"'),'V5.8.2: versão/cache bust ausente');
...
console.log('VALIDAÇÃO DE FONTE V5.8.2: PASS');
