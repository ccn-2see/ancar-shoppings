...
const checks = [
  [pkg.version === '5.8.7', 'versão 5.8.7'],
  ...
  [css.includes('.compact-esg-page .esg-dashboard-grid'), 'grid principal ESG V5.8.7'],
  [css.includes('.compact-esg-page .esg-equivalence-grid'), 'grid de equivalências ESG V5.8.7'],
];
...
if (!process.exitCode) console.log(`VALIDAÇÃO CONCEITO ENERGIA & CARBONO V5.8.7: ${passed}/${checks.length} PASS`);
