...
const checks = [
  [pkg.version === '5.8.6', 'versão 5.8.6'],
  ...
  [css.includes('.compact-esg-page .esg-dashboard-grid'), 'grid principal ESG V5.8.6'],
  [css.includes('.compact-esg-page .esg-equivalence-grid'), 'grid de equivalências ESG V5.8.6'],
];
...
if (!process.exitCode) console.log(`VALIDAÇÃO CONCEITO ENERGIA & CARBONO V5.8.6: ${passed}/${checks.length} PASS`);
