...
assert(pkg.version === '5.8.2', `Versão esperada 5.8.2; encontrada ${pkg.version}.`);
assert(rootRoute.includes('content: "5.8.2"') && rootRoute.includes('ancar-ui=5.8.2'), 'Cache bust/meta da V5.8.2 ausente.');

if (errors.length) {
  console.error(errors.join('\n'));
  process.exit(1);
}
console.log('VALIDAÇÃO NSM + STATUS/POWER FRONTEND V5.8.2: 9/9 PASS');
