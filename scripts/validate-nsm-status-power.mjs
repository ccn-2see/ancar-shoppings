...
assert(pkg.version === '5.8.3', `Versão esperada 5.8.3; encontrada ${pkg.version}.`);
assert(rootRoute.includes('content: "5.8.3"') && rootRoute.includes('ancar-ui=5.8.3'), 'Cache bust/meta da V5.8.3 ausente.');

if (errors.length) {
  console.error(errors.join('\n'));
  process.exit(1);
}
console.log('VALIDAÇÃO NSM + STATUS/POWER FRONTEND V5.8.3: 9/9 PASS');
