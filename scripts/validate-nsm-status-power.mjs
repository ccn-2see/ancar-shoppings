...
assert(pkg.version === '5.8.4', `Versão esperada 5.8.4; encontrada ${pkg.version}.`);
assert(rootRoute.includes('content: "5.8.4"') && rootRoute.includes('ancar-ui=5.8.4'), 'Cache bust/meta da V5.8.4 ausente.');

if (errors.length) {
  console.error(errors.join('\n'));
  process.exit(1);
}
console.log('VALIDAÇÃO NSM + STATUS/POWER FRONTEND V5.8.4: 9/9 PASS');
