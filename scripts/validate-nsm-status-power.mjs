...
assert(pkg.version === '5.8.8', `Versão esperada 5.8.8; encontrada ${pkg.version}.`);
assert(rootRoute.includes('content: "5.8.8"') && rootRoute.includes('ancar-ui=5.8.8'), 'Cache bust/meta da V5.8.8 ausente.');

if (errors.length) {
  console.error(errors.join('\n'));
  process.exit(1);
}
console.log('VALIDAÇÃO NSM + STATUS/POWER FRONTEND V5.8.8: 9/9 PASS');
